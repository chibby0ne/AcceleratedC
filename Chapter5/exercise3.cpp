/* By changing the two first typedef we can use lists instead of vectors for students' records */
#include <iostream>
#include <algorithm>
#include <list>
#include <iostream>
...
int main(int argc, const char *argv[])
{
    ...
    typedef sort(students.begin(), students.end(), compare) Sort;
    ...
    for (vector<Student_info>::iterator iter = 0; iter != students.end(); iter++) {
