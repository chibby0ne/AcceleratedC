...
void write_analysis(ostream& out, const string& name, double specific_analysis(const Student_info& s),
...
template <class T>
double analysis(const vector<Student_info>& students, T fun);
...
double analysis(const vector<Student_info>& students, T fun)
{
    ...
    transform(students.begin(), students.end(), back_inserter(grades), fun);
...
void write_analysis(ostream& out, const string& name, double specific_analysis(const Student_info& s), 
        const vector<Student_info>& did, const vector<Student_info>& didnt)
{
    out << name << ": median(did) = " << analysis(did, specific_analysis) << ": median(didnt) = " << analysis(didnt, specific_analysis) << endl;
}
