...
void write_analysis(ostream& out, const string& name, double grading_scheme(const Student_info &),
...
void write_analysis(ostream& out, const string& name, double grading_scheme(const Student_info& s), 
        const vector<Student_info>& did, const vector<Student_info>& didnt)
{
    out << name << ": median(did) = " << analysis(did, grading_scheme) << ": median(didnt) = " << analysis(didnt, grading_scheme) << endl;
}
